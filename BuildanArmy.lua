...
title.Text = "MR制作｜免费禁倒卖｜425695367｜组建军队脚本"
...
-- 创建按钮（使用不同颜色区分功能）
createButton("💰 开始刷钱", UDim2.new(0.075, 0, 0.25, 0), startMoneyFarm, Color3.fromRGB(40, 120, 60))
createButton("⚡ 开始卡服", UDim2.new(0.075, 0, 0.5, 0), startLagServer, Color3.fromRGB(120, 60, 40))
createButton("🛑 停止所有", UDim2.new(0.075, 0, 0.75, 0), stopAll, Color3.fromRGB(120, 40, 40))
...
infoLabel.Text = "拖动标题移动 | F:隐藏/显示 | R:重置位置"
